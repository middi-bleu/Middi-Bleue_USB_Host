...
${OBJECTDIR}/_ext/838585624/usb_host_cdc.o: ../../../../../../framework/usb/src/usb_host_cdc.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/838585624" 
	@${RM} ${OBJECTDIR}/_ext/838585624/usb_host_cdc.o.d 
	@${RM} ${OBJECTDIR}/_ext/838585624/usb_host_cdc.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/838585624/usb_host_cdc.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -DSYSTEM_PERIPHERAL_CLOCK=24000000 -I"." -I"../demo_src" -I"../../../../../../framework/usb/inc" -I"../../../../../../bsp/exp16/pic32mm0256gpm064_pim" -MMD -MF "${OBJECTDIR}/_ext/838585624/usb_host_cdc.o.d" -o ${OBJECTDIR}/_ext/838585624/usb_host_cdc.o ../../../../../../framework/usb/src/usb_host_cdc.c    -DXPRJ_PIC32MM0256GPM064_PIM=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD) 
	
${OBJECTDIR}/_ext/838585624/usb_host_cdc_interface.o: ../../../../../../framework/usb/src/usb_host_cdc_interface.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/838585624" 
	@${RM} ${OBJECTDIR}/_ext/838585624/usb_host_cdc_interface.o.d 
	@${RM} ${OBJECTDIR}/_ext/838585624/usb_host_cdc_interface.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/838585624/usb_host_cdc_interface.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -DSYSTEM_PERIPHERAL_CLOCK=24000000 -I"." -I"../demo_src" -I"../../../../../../framework/usb/inc" -I"../../../../../../bsp/exp16/pic32mm0256gpm064_pim" -MMD -MF "${OBJECTDIR}/_ext/838585624/usb_host_cdc_interface.o.d" -o ${OBJECTDIR}/_ext/838585624/usb_host_cdc_interface.o ../../../../../../framework/usb/src/usb_host_cdc_interface.c    -DXPRJ_PIC32MM0256GPM064_PIM=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/_ext/300881143/app_host_cdc_basic.o: ../demo_src/app_host_cdc_basic.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/300881143" 
	@${RM} ${OBJECTDIR}/_ext/300881143/app_host_cdc_basic.o.d 
	@${RM} ${OBJECTDIR}/_ext/300881143/app_host_cdc_basic.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/300881143/app_host_cdc_basic.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -DSYSTEM_PERIPHERAL_CLOCK=24000000 -I"." -I"../demo_src" -I"../../../../../../framework/usb/inc" -I"../../../../../../bsp/exp16/pic32mm0256gpm064_pim" -MMD -MF "${OBJECTDIR}/_ext/300881143/app_host_cdc_basic.o.d" -o ${OBJECTDIR}/_ext/300881143/app_host_cdc_basic.o ../demo_src/app_host_cdc_basic.c    -DXPRJ_PIC32MM0256GPM064_PIM=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD) 
